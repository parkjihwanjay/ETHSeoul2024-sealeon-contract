...
var ServiceStatus = /*#__PURE__*/function (ServiceStatus) {
  ServiceStatus[ServiceStatus["STOPPED"] = 0] = "STOPPED";
...
class Service {
  ...
  constructor(id, uuid, provider_address, price_per_minute_mantissa, start_timestamp,
...
class PayLog {
  constructor(pay_log_id, dueTimestamp, consumer_address, service_id, payed_amount, payed_usage_minute) {
    ...
    this.createAt = blockTimestamp();
  }
}
class UsageHistoryLog {
  constructor(service_id, pay_log_id, usage_minute) {
    this.service_id = service_id;
    this.pay_log_id = pay_log_id;
...
let Sealeon = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view(), _dec4 = call({
  payableFunction: true
}), _dec5 = call({}), _dec6 = call({}), _dec7 = view(), _dec8 = call({
  privateFunction: true
}), _dec9 = view(), _dec10 = view(), _dec11 = view(), _dec12 = view(), _dec13 = view(), _dec14 = view(), _dec15 = view(), _dec16 = view(), _dec17 = view(), _dec18 = view(), _dec19 = view(), _dec20 = view(), _dec21 = view(), _dec(_class = (_class2 = class Sealeon {
  // provider -> amount
  providerServiceLedger = new UnorderedMap('providerServiceLedger');
  // provider -> amount
  providerServiceEarned = new UnorderedMap('providerServiceEarned');
  // consumer_address -> using service
  consumerServiceMap = new UnorderedMap('consumerServiceMap');
  // service_list
  totalServiceList = new Vector('totalServiceList');
  // payLogs 
  payLogs = new Vector('payLogs');
  // payLogs 
  usageHistoryLogs = new Vector('usageHistoryLogs');
  // serviceId -> service
  serviceMap = new UnorderedMap('serviceMap');
  // platform 수수료
  platformFeeMap = new UnorderedMap('platformFeeMap');
  ...
  register_service({
    ...
    const start_timestamp = blockTimestamp();
    log(`start_timestamp: ${start_timestamp}`);
    if (end_timestamp < start_timestamp) throw new Error("Invalid end_timestamp");
    log('Creating Service');
    const service = new Service(serviceId, uuid, provider_address, price_per_minute_mantissa, start_timestamp, end_timestamp);
    log('Service Created');
    this.serviceMap.set(serviceId, service);
    log(`serviceMap: ${this.serviceMap.length}`);
  ...
  pay_service({
    ...
    log(`usage_minute: ${usage_minute}`);
    const consumer_address = signerAccountId();
    const transfer_amount = attachedDeposit();
    ...
    const preUsedService = this.get_service_by_consumer({
      consumer_address
    });
    if (preUsedService) {
      log("Already using service");
    ...
    log(`price_mantissa: ${price_mantissa}`);
    if (+transfer_amount.toString() < price_mantissa) {
      log("Insufficient transfer amount");
      throw new Error("Insufficient transfer amount");
    }
    const dueTimestamp = blockTimestamp() + this.minutesToNanoSeconds(usage_minute);
    log(`timestamp: ${blockTimestamp()}`);
    log(`dueTimestamp: ${dueTimestamp}`);
  ...
  stop_use_service({
    ...
    log(`current: ${blockTimestamp()}`);
    log(`lastPayLog.dueTimestamp: ${lastPayLog.dueTimestamp}`);
    if (blockTimestamp() > lastPayLog.dueTimestamp) throw new Error("already ended");
    ...
    const usageMinute = this.nanoSecondsToMinutes(blockTimestamp() - lastPayLog.createAt);
    const leftMinute = this.nanoSecondsToMinutes(lastPayLog.createAt + this.minutesToNanoSeconds(lastPayLog.payed_usage_minute) - blockTimestamp());
  ...
  isAvailableService({
    ...
    log(`available, service_id: ${service_id}`);
    ...
    if (service.end_timestamp < blockTimestamp()) {
      log("Service is already ended");
      return false;
    }
    const payLogList = this.payLogs.toArray().filter(l => l.service_id === service_id);
    const lastPayLog = payLogList[payLogList.length - 1];
    ...
    if (lastPayLog.dueTimestamp > blockTimestamp()) {
      return false;
    }
    return false;
  }
  nanoSecondsToMinutes(nanoSeconds) {
    return +nanoSeconds.toString() / 60_000_000_000;
  }
  minutesToNanoSeconds(minutes) {
  ...
  get_service_list() {
    return this.totalServiceList.toArray().filter(s => {
      ...
      if (s.end_timestamp < blockTimestamp()) return false;
      return true;
    });
  }
  get_service_list_by_provider({
    provider_address
  }) {
    return this.totalServiceList.toArray().filter(s => {
      return s.provider_address === provider_address && s.end_timestamp > blockTimestamp();
    });
  }
  get_ledger_by_provider_address({
    provider_address
  }) {
    return this.providerServiceLedger.get(provider_address);
  }
  get_earned_by_provider_address({
    provider_address
  }) {
  ...
  get_accured_pay_amount({
    service_id
  }) {
    return this.payLogs.toArray().filter(l => l.service_id === service_id && l.dueTimestamp < blockTimestamp()).reduce((acc, cur) => acc + cur.payed_amount, 0);
  }
  get_service({
    service_id
  }) {
  ...
  //   return amount;
  // }
}, (_applyDecoratedDescriptor(_class2.prototype, "register_service", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "register_service"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_admin_address", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_admin_address"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "pay_service", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "pay_service"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "stop_use_service", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "stop_use_service"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "stop_service_emergency", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "stop_service_emergency"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "isAvailableService", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "isAvailableService"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_transfer_callback", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_transfer_callback"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_available_service_list", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "get_available_service_list"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_service_list", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "get_service_list"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_service_list_by_provider", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "get_service_list_by_provider"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_ledger_by_provider_address", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "get_ledger_by_provider_address"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_earned_by_provider_address", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "get_earned_by_provider_address"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_pay_log_list", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "get_pay_log_list"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_accured_pay_amount", [_dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "get_accured_pay_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_service", [_dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "get_service"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_service_by_consumer", [_dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "get_service_by_consumer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_pay_logs_by_service_id", [_dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "get_pay_logs_by_service_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_usage_history_logs", [_dec19], Object.getOwnPropertyDescriptor(_class2.prototype, "get_usage_history_logs"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_provider_service_ledger", [_dec20], Object.getOwnPropertyDescriptor(_class2.prototype, "get_provider_service_ledger"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_service_list", [_dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_service_list"), _class2.prototype)), _class2)) || _class);
function get_all_service_list() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = Sealeon._create();
  if (_state) {
    Sealeon._reconstruct(_contract, _state);
  }
  const _args = Sealeon._getArgs();
  const _result = _contract.get_all_service_list(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_provider_service_ledger() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_provider_service_ledger(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_usage_history_logs() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_usage_history_logs(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_pay_logs_by_service_id() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_pay_logs_by_service_id(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_service_by_consumer() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_service_by_consumer(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_service() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_service(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_accured_pay_amount() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_accured_pay_amount(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_pay_log_list() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_pay_log_list(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_earned_by_provider_address() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_earned_by_provider_address(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_ledger_by_provider_address() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_ledger_by_provider_address(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_service_list_by_provider() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_service_list_by_provider(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_service_list() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_service_list(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_available_service_list() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_available_service_list(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function ft_transfer_callback() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.ft_transfer_callback(_args);
  Sealeon._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function isAvailableService() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.isAvailableService(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function stop_service_emergency() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.stop_service_emergency(_args);
  Sealeon._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function stop_use_service() {
  const _state = Sealeon._getState();
  if (!_state && Sealeon._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.stop_use_service(_args);
  Sealeon._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function pay_service() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.pay_service(_args);
  Sealeon._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function get_admin_address() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.get_admin_address(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}
function register_service() {
  ...
  const _args = Sealeon._getArgs();
  const _result = _contract.register_service(_args);
  Sealeon._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Sealeon._serialize(_result, true));
}

export { ft_transfer_callback, get_accured_pay_amount, get_admin_address, get_all_service_list, get_available_service_list, get_earned_by_provider_address, get_ledger_by_provider_address, get_pay_log_list, get_pay_logs_by_service_id, get_provider_service_ledger, get_service, get_service_by_consumer, get_service_list, get_service_list_by_provider, get_usage_history_logs, isAvailableService, pay_service, register_service, stop_service_emergency, stop_use_service };
//# sourceMappingURL=sealeon.js.map
